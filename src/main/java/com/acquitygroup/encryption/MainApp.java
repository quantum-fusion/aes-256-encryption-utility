...
public class MainApp {
    ...
    public static String showKey(AESCipher cipher) {

        LOG.debug("\n\nPrint SecretPrivateKey from JCEKS Keystore\n===========================================");
        LOG.debug("Key (Base64 Encoded): " + cipher.getKey(KeyEncoding.BASE64));
        LOG.debug("Key (Hex Encoded): " + cipher.getKey(KeyEncoding.HEX));
        LOG.debug("Key (Base32 Encoded): " + cipher.getKey(KeyEncoding.BASE32));

        return cipher.getKey(KeyEncoding.BASE64);
